...
class ScaleTransition : Transition {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        ...
        startScaleX = a.getFloat(R.styleable.CustomScaleTransition_startScaleX, startScaleX)
        startScaleY = a.getFloat(R.styleable.CustomScaleTransition_startScaleY, startScaleY)

        endScaleX = a.getFloat(R.styleable.CustomScaleTransition_startScaleX, endScaleX)
